...
for event = eventList
    ...
    xticklabels({'Low Uncertainity (25th Pct)', ...
        'High Uncertainity (75th Pct)'})
    ...
    exName = strcat(out_std_dir, 'iv/', event, '.jpg');
    exportgraphics(fig, exName{:});
end

fprintf('Construct standard deviation bucket graph by swap term and tenor.\n')